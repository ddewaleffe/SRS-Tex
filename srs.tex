...
\begin{reqmt}[Toolbox-MultipleChoice]
...
\begin{reqmt}[Toolbox-multiple-kinds]
...
\begin{reqmt}[Toolbox-PerUser-assertion]
...
\end{reqmt}
  ...
  \begin{module}{Toolbox-Users}
    \begin{decls}{Definitions}
      AD  Users == "Set of all users known in Active Directory" \\
      AD Groups  == "Set of all groups known in Active Directory"\\
      ToolboxUserMenu == "Set of Users show in potential selection"\\
      GroupList == \SUBSET{AD  Groups}\\
      RoleList == "Set of Application Roles"\\
      ApplicationList == "Set of Applications"
    \end{decls}
    ...
    \begin{decls}{actions}
      ...
      \begin{conj}
        user \in AllUsers\\
        IsEnabled(user) \lor \lnot IsEnabled(user)\\
      \end{conj}
    \end{decls}
    $\A user \in AllUsers : IsEnabled(user) => user \in
    ToolboxUserMenu $
  \end{module}
  \notla
...
\end{reqmt}
\begin{reqmt}[Toolbox-PerApplication]
